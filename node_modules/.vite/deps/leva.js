  ...
  const a4 = (e5, t5, r5) => {
    ...
    const p4 = (e6) => {
      for (c4 in e6) {
        ...
        for (g4 of z2) {
          const e7 = /[A-Z]/.test($3 = c4) ? $3 : $3.replace(/-[^]/g, ((e8) => e8[1].toUpperCase())), z3 = "object" == typeof g4 && g4 && g4.toString === B && (!n4.utils[e7] || !t5.length);
...
function render(element, container) {
  ...
  import_react_dom6.default.render(element, container);
  console.error = error;
}
...
function i3(e4) {
  var n4 = (0, import_react29.useRef)(e4), t4 = (0, import_react29.useRef)(function(e5) {
...
var d3 = function(e4, r4, n4) {
  var t4 = e4.getBoundingClientRect(), o4 = f3(r4) ? (function(e5, r5) {
    for (var n5 = 0; n5 < e5.length; n5++) if (e5[n5].identifier === r5) return e5[n5];
    return e5[0];
  })(r4.touches, n4) : r4;
  return { left: s3((o4.pageX - (t4.left + v3(e4).pageXOffset)) / t4.width), top: s3((o4.pageY - (t4.top + v3(e4).pageYOffset)) / t4.height) };
};
var h3 = function(e4) {
  !f3(e4) && e4.preventDefault();
};
var g3 = import_react29.default.memo(function(o4) {
  var a4 = o4.onMove, l4 = o4.onKey, s4 = o4.onEnd, g4 = c3(o4, ["onMove", "onKey", "onEnd"]), m4 = (0, import_react29.useRef)(null), p4 = i3(a4), b4 = i3(l4), _2 = i3(s4), E2 = (0, import_react29.useRef)(null), C2 = (0, import_react29.useRef)(false), x3 = (0, import_react29.useMemo)(function() {
    var e4 = function(e5) {
      h3(e5), (f3(e5) ? e5.touches.length > 0 : e5.buttons > 0) && m4.current ? p4(d3(m4.current, e5, E2.current)) : (n4(false), _2());
    }, r4 = function() {
      n4(false), _2();
    };
    function n4(n5) {
      var t4 = C2.current, o5 = v3(m4.current), a5 = n5 ? o5.addEventListener : o5.removeEventListener;
    ...
    return [function(e5) {
      ...
      if (t4 && (h3(r5), !(function(e6, r6) {
        ...
        t4.focus(), p4(d3(t4, r5, E2.current)), n4(true);
      }
    }, function(e5) {
  ...
  return (0, import_react29.useEffect)(function() {
    return w3;
  }, [w3]), import_react29.default.createElement("div", u3({}, g4, { onTouchStart: H3, onMouseDown: H3, className: "react-colorful__interactive", ref: m4, onKeyDown: M3, onKeyUp: N3, tabIndex: 0, role: "slider" }));
});
var m3 = function(e4) {
  return e4.filter(Boolean).join(" ");
};
var p3 = function(r4) {
  var n4 = r4.color, t4 = r4.left, o4 = r4.top, a4 = void 0 === o4 ? 0.5 : o4, l4 = m3(["react-colorful__pointer", r4.className]);
  return import_react29.default.createElement("div", { className: l4, style: { top: 100 * a4 + "%", left: 100 * t4 + "%" } }, import_react29.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: n4 } }));
};
...
var I3 = function(e4) {
  ...
  var a4 = Math.floor(r4), l4 = t4 * (1 - n4), u4 = t4 * (1 - (r4 - a4) * n4), c4 = t4 * (1 - (1 - r4 + a4) * n4), i4 = a4 % 6;
  return { r: b3(255 * [t4, u4, l4, l4, c4, t4][i4]), g: b3(255 * [c4, t4, t4, u4, l4, l4][i4]), b: b3(255 * [l4, l4, c4, t4, t4, u4][i4]), a: b3(o4, 2) };
};
var L2 = function(e4) {
  var r4 = e4.r, n4 = e4.g, t4 = e4.b, o4 = e4.a, a4 = Math.max(r4, n4, t4), l4 = a4 - Math.min(r4, n4, t4), u4 = l4 ? a4 === r4 ? (n4 - t4) / l4 : a4 === n4 ? 2 + (t4 - r4) / l4 : 4 + (r4 - n4) / l4 : 0;
...
var S3 = import_react29.default.memo(function(r4) {
  ...
  return import_react29.default.createElement("div", { className: a4 }, import_react29.default.createElement(g3, { onMove: function(e4) {
    t4({ h: 360 * e4.left });
  }, onKey: function(e4) {
    t4({ h: s3(n4 + 360 * e4.left, 0, 360) });
  }, onEnd: o4, "aria-label": "Hue", "aria-valuenow": b3(n4), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react29.default.createElement(p3, { className: "react-colorful__hue-pointer", left: n4 / 360, color: q2({ h: n4, s: 100, v: 100, a: 1 }) })));
});
var T2 = import_react29.default.memo(function(r4) {
  var n4 = r4.hsva, t4 = r4.onChange, o4 = r4.onChangeEnd, a4 = { backgroundColor: q2({ h: n4.h, s: 100, v: 100, a: 1 }) };
  return import_react29.default.createElement("div", { className: "react-colorful__saturation", style: a4 }, import_react29.default.createElement(g3, { onMove: function(e4) {
    t4({ s: 100 * e4.left, v: 100 - 100 * e4.top });
  }, onKey: function(e4) {
    t4({ s: s3(n4.s + 100 * e4.left, 0, 100), v: s3(n4.v - 100 * e4.top, 0, 100) });
  }, onEnd: o4, "aria-label": "Color", "aria-valuetext": "Saturation " + b3(n4.s) + "%, Brightness " + b3(n4.v) + "%" }, import_react29.default.createElement(p3, { className: "react-colorful__saturation-pointer", top: 1 - n4.v / 100, left: n4.s / 100, color: q2(n4) })));
});
...
function Y2(e4, n4, l4, u4) {
  var c4 = i3(l4), s4 = i3(u4), f4 = (0, import_react29.useState)(function() {
    return e4.toHsva(n4);
  }), v4 = f4[0], d4 = f4[1], h4 = (0, import_react29.useRef)({ color: n4, hsva: v4 }), g4 = (0, import_react29.useRef)(false);
  (0, import_react29.useEffect)(function() {
    if (!e4.equal(n4, h4.current.color)) {
      var r4 = e4.toHsva(n4);
      h4.current = { hsva: r4, color: n4 }, d4(r4), g4.current = false;
    }
  }, [n4, e4]), (0, import_react29.useEffect)(function() {
    var r4;
    F2(v4, h4.current.hsva) || e4.equal(r4 = e4.fromHsva(v4), h4.current.color) || (h4.current = { hsva: v4, color: r4 }, c4(r4), g4.current = true);
  }, [v4, e4, c4]);
  var m4 = (0, import_react29.useCallback)(function(e5) {
    d4(function(r4) {
      return Object.assign({}, r4, e5);
    });
  }, []), p4 = (0, import_react29.useCallback)(function() {
    g4.current && (g4.current = false, s4(h4.current.color));
  }, [s4]);
  return [v4, m4, p4];
}
var R2;
var U2 = "undefined" != typeof window ? import_react29.useLayoutEffect : import_react29.useEffect;
var V2 = function() {
  return R2 || ("undefined" != typeof __webpack_nonce__ ? __webpack_nonce__ : void 0);
};
var G2 = /* @__PURE__ */ new Map();
var J2 = function(e4) {
  U2(function() {
    var r4 = e4.current ? e4.current.ownerDocument : document;
    if (void 0 !== r4 && !G2.has(r4)) {
      var n4 = r4.createElement("style");
      n4.innerHTML = `.react-colorful{position:relative;display:flex;flex-direction:column;width:200px;height:200px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default}.react-colorful__saturation{position:relative;flex-grow:1;border-color:transparent;border-bottom:12px solid #000;border-radius:8px 8px 0 0;background-image:linear-gradient(0deg,#000,transparent),linear-gradient(90deg,#fff,hsla(0,0%,100%,0))}.react-colorful__alpha-gradient,.react-colorful__pointer-fill{content:"";position:absolute;left:0;top:0;right:0;bottom:0;pointer-events:none;border-radius:inherit}.react-colorful__alpha-gradient,.react-colorful__saturation{box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}.react-colorful__alpha,.react-colorful__hue{position:relative;height:24px}.react-colorful__hue{background:linear-gradient(90deg,red 0,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,red)}.react-colorful__last-control{border-radius:0 0 8px 8px}.react-colorful__interactive{position:absolute;left:0;top:0;right:0;bottom:0;border-radius:inherit;outline:none;touch-action:none}.react-colorful__pointer{position:absolute;z-index:1;box-sizing:border-box;width:28px;height:28px;transform:translate(-50%,-50%);background-color:#fff;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2)}.react-colorful__interactive:focus .react-colorful__pointer{transform:translate(-50%,-50%) scale(1.1)}.react-colorful__alpha,.react-colorful__alpha-pointer{background-color:#fff;background-image:url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')}.react-colorful__saturation-pointer{z-index:3}.react-colorful__hue-pointer{z-index:2}`, G2.set(r4, n4);
      var t4 = V2();
      t4 && n4.setAttribute("nonce", t4), r4.head.appendChild(n4);
    }
  }, []);
};
var Q = function(n4) {
  var t4 = n4.className, o4 = n4.colorModel, a4 = n4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = n4.onChange, s4 = n4.onChangeEnd, f4 = c3(n4, ["className", "colorModel", "color", "onChange", "onChangeEnd"]), v4 = (0, import_react29.useRef)(null);
  J2(v4);
  var d4 = Y2(o4, l4, i4, s4), h4 = d4[0], g4 = d4[1], p4 = d4[2], b4 = m3(["react-colorful", t4]);
  return import_react29.default.createElement("div", u3({}, f4, { ref: v4, className: b4 }), import_react29.default.createElement(T2, { hsva: h4, onChange: g4, onChangeEnd: p4 }), import_react29.default.createElement(S3, { hue: h4.h, onChange: g4, onChangeEnd: p4, className: "react-colorful__last-control" }));
};
var ee = function(r4) {
  var n4 = r4.className, t4 = r4.hsva, o4 = r4.onChange, a4 = r4.onChangeEnd, l4 = { backgroundImage: "linear-gradient(90deg, " + k3(Object.assign({}, t4, { a: 0 })) + ", " + k3(Object.assign({}, t4, { a: 1 })) + ")" }, u4 = m3(["react-colorful__alpha", n4]), c4 = b3(100 * t4.a);
  return import_react29.default.createElement("div", { className: u4 }, import_react29.default.createElement("div", { className: "react-colorful__alpha-gradient", style: l4 }), import_react29.default.createElement(g3, { onMove: function(e4) {
    o4({ a: e4.left });
  }, onKey: function(e4) {
    o4({ a: s3(t4.a + e4.left) });
  }, onEnd: a4, "aria-label": "Alpha", "aria-valuetext": c4 + "%", "aria-valuenow": c4, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react29.default.createElement(p3, { className: "react-colorful__alpha-pointer", left: t4.a, color: k3(t4) })));
};
var re = function(n4) {
  var t4 = n4.className, o4 = n4.colorModel, a4 = n4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = n4.onChange, s4 = n4.onChangeEnd, f4 = c3(n4, ["className", "colorModel", "color", "onChange", "onChangeEnd"]), v4 = (0, import_react29.useRef)(null);
  J2(v4);
  var d4 = Y2(o4, l4, i4, s4), h4 = d4[0], g4 = d4[1], p4 = d4[2], b4 = m3(["react-colorful", t4]);
  return import_react29.default.createElement("div", u3({}, f4, { ref: v4, className: b4 }), import_react29.default.createElement(T2, { hsva: h4, onChange: g4, onChangeEnd: p4 }), import_react29.default.createElement(S3, { hue: h4.h, onChange: g4, onChangeEnd: p4 }), import_react29.default.createElement(ee, { hsva: h4, onChange: g4, onChangeEnd: p4, className: "react-colorful__last-control" }));
};
var Ee = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: F2 };
var Ce = function(r4) {
  return import_react29.default.createElement(re, u3({}, r4, { colorModel: Ee }));
};
...
var Ne = function(r4) {
  return import_react29.default.createElement(Q, u3({}, r4, { colorModel: Me }));
};
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          render(import_react32.default.createElement(Leva, {
            isRoot: true
          }), rootEl);
        }
      }
